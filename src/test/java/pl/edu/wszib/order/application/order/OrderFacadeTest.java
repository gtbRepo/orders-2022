...
public class OrderFacadeTest {
    //T2: można dodać pozycjędo zamówienia
    ...
    public void should_be_able_to_add_item_to_order() {
        ...
        final OrderItemAddApi itemToAdd =new OrderItemAddApi(
                ProductSamples.CHOCOLATE.getId().asBasicType(), 1);
        ...
        assertTrue(foundOrder.isPresent());
        boolean orderContainsProductWeWantedToAdd = foundOrder.get().getItems().stream()
                .anyMatch(orderItemApi -> orderItemApi.getProductId().equals(itemToAdd.getProductId()));
